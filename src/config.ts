...
export const testimonialsConfig: TestimonialsConfig = {
  ...
  testimonials: [
    {
      quote: "Max Escobari lideró el diseño e implementación del SIAF en el Hospital Universitario Japonés, coordinando la capacitación del personal para asegurar su sostenibilidad. Su enfoque estratégico y su habilidad para gestionar equipos multidisciplinarios fueron determinantes en el éxito del primer ERP hospitalario en operar sobre una red LAN en Bolivia.",
      author: "Toichiro ISO",
      role: "Experto en Gestión Hospitalaria",
      company: "JICA Japón",
      image: "/images/testimonial-1.jpg",
      rating: 5,
    },
    {
      quote: "El Ing. Max Escobari desempeñó un papel clave en la transformación tecnológica de la DIGEMIG. Su liderazgo técnico fue esencial para la creación e implementación del sistema de Pasaportes Electrónicos de Bolivia, alineado con las normativas de la OACI. Gracias a su sólida experiencia en gestión de proyectos de gran escala, se logró un sistema seguro y eficiente que consolidó la modernización institucional.",
      author: "Mercedes URQUIOLA",
      role: "Responsable de Sistemas",
      company: "DIGEMIG – Ministerio de Gobierno, Bolivia",
      image: "/images/testimonial-2.jpg",
      rating: 5,
    },
    {
      quote: "Max was my right hand — I placed my full trust in him to help navigate a very complex environment. He was loyal, committed, and always dependable. He is one of those rare individuals who not only generates ideas but also steps up at the right moment. He thinks outside the box and brings innovative solutions when they are most needed.",
      author: "Paolo TOSELLI",
      role: "Geo-Coordination for Brazil",
      company: "European Commission",
      image: "/images/testimonial-3.jpg",
      rating: 5,
    },
    {
      quote: "Trabajar con Max Escobari durante casi cinco años fue clave para la modernización de nuestra gestión. Lideró la migración de nuestro sistema contable presupuestario a una plataforma web moderna, e integró el sistema contable con nuestra plataforma de monitoreo. Su excelencia técnica, liderazgo estratégico y compromiso con la sostenibilidad tecnológica dejaron un impacto duradero en nuestra organización.",
      author: "Delsy MERINO",
